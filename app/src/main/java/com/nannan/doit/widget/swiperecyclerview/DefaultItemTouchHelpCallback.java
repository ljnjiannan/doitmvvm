...
public class DefaultItemTouchHelpCallback extends ItemTouchHelper.Callback {
  ...
  public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
    if (onItemTouchCallbackListener != null) {
      Log.i("DefaultItemTouch", "onSwiped: " + direction);
      onItemTouchCallbackListener.onSwiped(viewHolder.getAdapterPosition(), direction);
    }
  }
  ...
  public void onChildDraw(Canvas c, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder,
    ...
    onItemTouchCallbackListener.onChildDraw(c, recyclerView, viewHolder, dX, dY, actionState,
        isCurrentlyActive);
  }
